...
export const gameCfgs: Record<string, GameConfig> = {
  ...
  'DMG-APSF-0': {name: 'Pokemon - Version Jaune - Edition Speciale Pikachu (France) (GBC,SGB Enhanced)', layout: 'rom_mbc_ram'},
  'DMG-APSU-0': {name: 'Pokemon - Yellow Version - Special Pikachu Edition (USA, Europe) (GBC,SGB Enhanced)', layout: 'rom_mbc_ram'},
